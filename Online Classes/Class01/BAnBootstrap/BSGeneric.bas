...
#DesignerProperty: Key: TagName, DisplayName: Tag Name, FieldType: String, DefaultValue: , Description: HTML Tag
#DesignerProperty: Key: Text, DisplayName: Text, FieldType: String, DefaultValue: , Description: HTML Text
#DesignerProperty: Key: StyleHeight, DisplayName: Style Height, FieldType: String, DefaultValue: , Description: HTML Style Height
#DesignerProperty: Key: StyleWidth, DisplayName: Style Width, FieldType: String, DefaultValue: , Description: HTML Style Width
#DesignerProperty: Key: BackgroundColor, DisplayName: Background Color, FieldType: String, DefaultValue: , Description: HTML Background Color
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	mElement = mTarget.Append($"<${mTagName} id="${mName}" class="${mClasses}" style="${exStyle}${mStyle}"></${mTagName}>"$).Get("#" & mName)
	
	mElement.SetText(mText)
		
	'' defining events is very simple. Note that it has to be run AFTER adding it to the HTML DOM! eventName must be lowercase!
	mElement.HandleEvents("click", mCallBack, mEventName & "_click")
	mElement.HandleEvents("change", mCallBack, mEventName & "_change")
...
public Sub BuildExStyle() As String
	...
	If mStyleHeight <> "" Then sb.Append("height: " & mStyleHeight & ";")
	If mStyleWidth <> "" Then sb.Append("width: " & mStyleWidth & ";")
	If mBackgroundColor <> "" Then sb.Append("background-color: " & mBackgroundColor & ";")
	Return sb.ToString
End Sub
