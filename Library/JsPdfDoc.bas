...
Sub DesignerCreateView (Target As BANanoElement, Props As Map) 
	...
	If Props <> Null Then 
		...
		bCompress = BANanoShared.parseBool(bCompress)
		...
		ShowLog = BANanoShared.parseBool(ShowLog)
	End If 
	'
