...
#DesignerProperty: Key: CollapseOnScroll, DisplayName: CollapseOnScroll, FieldType: Boolean, DefaultValue: false, Description: CollapseOnScroll
...
#DesignerProperty: Key: ExtensionHeight, DisplayName: ExtensionHeight, FieldType: String, DefaultValue: 48, Description: ExtensionHeight
#DesignerProperty: Key: FadeImgOnScroll, DisplayName: FadeImgOnScroll, FieldType: Boolean, DefaultValue: false, Description: FadeImgOnScroll
...
#DesignerProperty: Key: InvertedScroll, DisplayName: InvertedScroll, FieldType: Boolean, DefaultValue: false, Description: InvertedScroll
...
#DesignerProperty: Key: ShrinkOnScroll, DisplayName: ShrinkOnScroll, FieldType: Boolean, DefaultValue: false, Description: ShrinkOnScroll
...
Private bShrinkOnScroll As Boolean
...
sProgressLoaderColorIntensity = Props.GetDefault("ProgressLoaderColorIntensity", "")
	...
	Else	
		mElement = mTarget.Append($"<v-app-bar id="${mName}"></v-app-bar>"$).Get("#" & mName)
	End If
	'
...
VElement.ClippedLeft = bClippedLeft
...
VElement.FadeImgOnScroll = bFadeImgOnScroll
VElement.Fixed = bFixed
VElement.Flat = bFlat
VElement.Floating = bFloating
VElement.Height = sHeight
VElement.HideOnScroll = bHideOnScroll
VElement.AddAttr(":inverted-scroll", bInvertedScroll)
...
Sub AddClass(s As String) As VAppBar
	VElement.AddClass(s)
	Return Me
End Sub

Sub AddAttr(p As String, v As Object) As VAppBar
	VElement.SetAttr(p, v)
	Return Me
End Sub

Sub AddStyle(p As String, v As String) As VAppBar
	VElement.AddStyle(p, v)
	Return Me
End Sub

Sub RemoveAttr(p As String) As VAppBar
