...
Sub Class_Globals
	...
	Public ProfilePicture As Boolean
	Public Image As Boolean
	Public Avatar As Boolean
	Public ReAction As Boolean
	Public RagCircle As Boolean
	Public Gender As Boolean
	Public UpDown As Boolean
	Public RagSmiley As Boolean
	Public Color As Boolean
	
	Public const DT_COLOR As String = "color"
	Public const DT_REACTION As String = "reaction"
	Public const DT_RAG_CIRCLE As String = "ragcircle"
	Public const DT_RAG_SMILEY As String = "ragsmile"
	Public const DT_GENDER As String = "gender"
	Public const DT_UP_DOWN As String = "updown"	
	Public const DT_AVATAR As String = "avatar"
	Public const DT_IMAGE As String = "image"
	Public const DT_PROFILE_PICTURE As String = "profilepicture"
...
Sub Initialize As BANanoFakeIT
	...
	DT_Types.Add(DT_PROFILE_PICTURE)
	DT_Types.Add(DT_IMAGE)
	DT_Types.Add(DT_AVATAR)
	DT_Types.Add(DT_REACTION)
	DT_Types.Add(DT_RAG_CIRCLE)
	DT_Types.Add(DT_RAG_SMILEY)
	DT_Types.Add(DT_GENDER)
	DT_Types.add(DT_UP_DOWN)
	DT_Types.Add("")
	TrueOrFalse = False
	PrimaryKey = True
	Password =False
...
private Sub ListToMap(lst As List) As Map
		...
		For Each strkey As String In structure.Keys
			...
			Select Case strVal
				Case DT_COLOR
					svalue = Rand_Color
				Case DT_REACTION
					svalue = Rand_Reaction
				Case DT_RAG_CIRCLE
					svalue = Rand_Rag_Circles
				Case DT_RAG_SMILEY
					svalue = Rand_Smiley
				Case DT_GENDER
					svalue = Rand_UpDown
...
private Sub Rand_Reaction As Int
	Return Rnd(1,6)
End Sub

private Sub Rand_Rag_Circles As Int
	Return Rnd(1,4)
End Sub

private Sub Rand_Smiley As Int
	Return Rnd(1, 3)
End Sub

private Sub Rand_UpDown As Int
	Return Rnd(1, 2)
End Sub
...
Sub GetRecords(numRecords As Int) As List
	...
	For tRecs = 1 To numRecords
		Dim rec As Map
		rec.Initialize
		If Color Then rec.Put("color", Rand_Color)
		If ReAction Then rec.Put("reaction", Rand_Reaction)
		If RagCircle Then rec.Put("ragcircle", Rand_Rag_Circles)
		If Gender Then rec.Put("gender", Rand_UpDown)
		If UpDown Then rec.Put("updown", Rand_UpDown)
		If RagSmiley Then rec.put("ragsmiley", Rand_Smiley)
		If Avatar Then rec.Put("avatar", Rand_Avatar)
		If ProfilePicture Then rec.Put("profilepicture", Rand_ProfilePic)
		If Image Then rec.Put("image", Rand_Image)
		If PrimaryKey Then rec.Put("primarykey", tRecs)
		...
		If DateAndTime Then rec.Put("dateandtime", Rand_DateTime)
		...
		If TrueOrFalse Then rec.Put("trueorfalse", Rand_True_Or_False)
...
Sub Rand_Age_Child(Options As Map) As String
	Dim m As Map = CreateMap()
	m.Put("type","child")
	Return Rand_Age(m)
End Sub

Sub Rand_Age_Teen(Options As Map) As String
	Dim m As Map = CreateMap()
	m.Put("type","teen")
	Return Rand_Age(m)
End Sub

Sub Rand_Age_Adult(Options As Map) As String
	Dim m As Map = CreateMap()
	m.Put("type","adult")
	Return Rand_Age(m)
End Sub

Sub Rand_Age_Senior(Options As Map) As String
	Dim m As Map = CreateMap()
	m.Put("type","senior")
	Return Rand_Age(m)
End Sub

Sub Rand_Age_Any(Options As Map) As String
	Dim m As Map = CreateMap()
	m.Put("type","all")
	Return Rand_Age(m)
End Sub
...
Sub Rand_Color As String
	...
	colors.Add("white")
	colors.Add("yellow")
	colors = ExplodeList(colors,5)
	Return RandListValue(colors)
End Sub


Sub Rand_Image As String
	Dim images As List
	images.Initialize 
	images.Add("./assets/1.jpg")
	images.Add("./assets/2.jpg")
	images.Add("./assets/3.jpg")
	images.Add("./assets/4.jpg")
	images.Add("./assets/5.jpg")
	images.Add("./assets/bird.jpg")
	images.Add("./assets/login.jpg")
	images.Add("./assets/sample-1.jpg")
	images.Add("./assets/parallax1.jpg")
	images.Add("./assets/parallax2.jpg")
	images.Add("./assets/office.jpg")
	images.Add("./assets/kitchen.png")
	images.Add("./assets/lock.jpg")
	images.Add("./assets/login.jpg")
	images.Add("./assets/cooking.png")
	images.Add("./assets/office.jpg")
	images.Add("./assets/planet.jpg")
	images.Add("./assets/pricing.jpg")
	images.Add("./assets/register.jpg")
	images.Add("./assets/flower.jpeg")
	images.Add("./assets/profile10.jpg")
	images.Add("./assets/profile11.jpg")
	images.Add("./assets/profile12.jpg")
	images.Add("./assets/profile13.jpg")
	images = ExplodeList(images,5)
	Return RandListValue(images)
End Sub

Sub Rand_ProfilePic As String
	Dim images As List
	images.Initialize 
	images.Add("./assets/1.jpg")
	images.Add("./assets/2.jpg")
...
Sub Rand_Avatar As String
	Dim images As List
	images.Initialize 
	images.Add("./assets/img1.png")
	images.Add("./assets/img2.png")
	images.Add("./assets/img3.png")
	images.Add("./assets/img4.png")
	images.Add("./assets/img5.png")
	images.Add("./assets/img6.png")
	images.Add("./assets/img7.png")
	images.Add("./assets/img8.png")
	images.Add("./assets/img9.png")
	images = ExplodeList(images,5)
	Return RandListValue(images)
End Sub
