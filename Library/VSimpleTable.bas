...
Sub DesignerCreateView (Target As BANanoElement, Props As Map) 
	...
	'
	lstColumns = BANanoShared.StrParse(";", sColumns)
	lstColumns = BANanoShared.ListTrimItems(lstColumns)
	'
	lstTitles = BANanoShared.StrParse(";", sTitles)
	lstTitles = BANanoShared.ListTrimItems(lstTitles)
	
	lstWidths = BANanoShared.StrParse(";", sWidths)
	lstWidths = BANanoShared.ListTrimItems(lstWidths)
	'
	lstCentered = BANanoShared.StrParse(";", sColumnCenterAlign)
	lstCentered = BANanoShared.ListTrimItems(lstCentered)
	'
	lstRightAligned = BANanoShared.StrParse(";", sColumnRightAlign)
	lstRightAligned = BANanoShared.ListTrimItems(lstRightAligned)
	'
	lstHiddenColumns = BANanoShared.StrParse(";", sHiddenColumns)
	lstHiddenColumns = BANanoShared.ListTrimItems(lstHiddenColumns)
	'
	lstCheckBoxes = BANanoShared.StrParse(";", sCheckBoxes)
