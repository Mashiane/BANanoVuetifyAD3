...
#DesignerProperty: Key: CloseOnClick, DisplayName: CloseOnClick, FieldType: Boolean, DefaultValue: false, Description: CloseOnClick
#DesignerProperty: Key: CloseOnContentClick, DisplayName: CloseOnContentClick, FieldType: Boolean, DefaultValue: false, Description: CloseOnContentClick
...
#DesignerProperty: Key: NudgeWidth, DisplayName: NudgeWidth, FieldType: String, DefaultValue: , Description: NudgeWidth
...
#DesignerProperty: Key: Position, DisplayName: Position, FieldType: String, DefaultValue: , Description: Position, List: none|bottom|left|right|top
...
Private bCloseOnClick As Boolean
Private bCloseOnContentClick As Boolean
...
VElement.AddAttr(":close-on-click", bCloseOnClick)
VElement.AddAttr(":close-on-content-click", bCloseOnContentClick)
...
VElement.AddAttr("nudge-width", sNudgeWidth)
...
Sub Visible(VC As VueComponent, b As Boolean) As VMenu
	VC.SetData(sVIf, b)
	VC.SetData(sVShow, b)
	Return Me
End Sub
