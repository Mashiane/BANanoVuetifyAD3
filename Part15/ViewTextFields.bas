...
'	
	...
	Dim txtusername1 As BANanoElement = BVAD3.NewTextField(textfields, "txtUserName1", "username", "User Name", "", True, "mdi-account-circle", 0, "")
	vtextfieldcontainer.Matrix(4, 1).Append(txtusername1.GetHTML)
	'
	Dim txtpassword1 As BANanoElement = BVAD3.NewPassword(textfields, "txtPassword1", "pwd", "Password", "", True, "mdi-lock", 10, "")
