...
Sub btn1_click(e As BANanoEvent)
	'updte the title of the dialog
	inputdialog.DialogUpdateTitle("dlg1", "Add a User Profile")
	'open the dialog named dlg1
...
Sub CreateDialog1
	...
	'
	'show the grid design inside the container
	'dlg1Cnt.ShowGridDesign = True
	'add 1 row with 3 columns
	dlg1Cnt.AddRows1.AddColumns3x4
	'add 2 rows with 2 columns
