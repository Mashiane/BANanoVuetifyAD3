...
Sub WebSocket_Connected()
	...
	vuetify.SetMethod(Me, "JRDC2OnBrowser", Null)
...
Sub AddDrawer
	...
	drwlist.AddItemParentChild("backend", "mysql", "mdi-database", "", "MySQL jRDC2", ViewJRDC2.path)
