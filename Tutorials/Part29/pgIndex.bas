...
Sub Init
	...
	'define drawer
	BVAD3.NewListIconTitleOnApp(vuetify, "vappdrawer", "drwlist", "links", "title", "icon", "title", "to", _
	Null, CreateMap("active-class":"border"), CreateMap("class":"white--text"), CreateMap("class":"white--text"))
