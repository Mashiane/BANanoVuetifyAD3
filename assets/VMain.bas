...
'Definition of variables used in this VMain component.
'Definition of variables used in this VMain component.
Sub Class_Globals
...
End Sub
'Initializes the VMain component.
'Initializes the VMain component.
...
'This builds the HTML tree based on defined properties for VMain
'This builds the HTML tree based on defined properties for VMain
...
Else
mElement = mTarget.Append($"<v-main id="${mName}"></v-main>"$).Get("#" & mName)
End If
VElement.Initialize(mCallBack, mName, mName)
VElement.TagName = "v-main"
...
BANano.SetMeToNull
End Sub
Sub AddClass(s As String) As VMain
VElement.AddClass(s)
Return Me
End Sub
Sub AddAttr(p As String, v As Object) As VMain
VElement.SetAttr(p, v)
Return Me
End Sub
Sub AddStyle(p As String, v As String) As VMain
VElement.AddStyle(p, v)
Return Me
End Sub
Sub RemoveAttr(p As String) As VMain
