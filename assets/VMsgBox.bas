...
#DesignerProperty: Key: CancelColor, DisplayName: Cancel Color, FieldType: String, DefaultValue: grey, Description: The color of the Cancel button, List: amber|black|blue|blue-grey|brown|cyan|deep-orange|deep-purple|green|grey|indigo|light-blue|light-green|lime|orange|pink|purple|red|teal|transparent|white|yellow|primary|secondary|accent|error|info|success|warning|none
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: fab-transition, Description: Transition, List: none|fab-transition|fade-transition|expand-transition|scale-transition|scroll-x-transition|scroll-x-reverse-transition|scroll-y-transition|scroll-y-reverse-transition|slide-x-transition|slide-x-reverse-transition|slide-y-transition|slide-y-reverse-transition|dialog-bottom-transition|dialog-top-transition
...
'Definition of variables used in this VMsgBox component.
'Definition of variables used in this VMsgBox component.
Sub Class_Globals
...
End Sub
'Initializes the VMsgBox component.
'Initializes the VMsgBox component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VMsgBox
'This builds the HTML tree based on defined properties for VMsgBox
...
UpdateTitle(VC, sTitle)
sToolbarCaption = sTitle
End Sub
'update title on app
...
End Sub
Sub setOkLabel(s As String)
UpdateOkLabel(VC, s)
End Sub
Sub setCancelLabel(s As String)
UpdateCancelLabel(VC, s)
End Sub
...
End Sub
Sub setOkLoading(b As Boolean)
UpdateOkLoading(VC, b)
End Sub
Sub setCancelLoading(b As Boolean)
UpdateCancelLoading(VC, b)
End Sub
Sub setOkEnabled(b As Boolean)
UpdateOkDisabled(VC, Not(b))
End Sub
Sub setCancelEnabled(b As Boolean)
UpdateCancelDisabled(VC, Not(b))
End Sub
Sub setOkVisible(b As Boolean)
UpdateOkVisible(VC, b)
End Sub
Sub setCancelVisible(b As Boolean)
UpdateCancelVisible(VC, b)
End Sub
