...
'Definition of variables used in this VBadge component.
'Definition of variables used in this VBadge component.
Sub Class_Globals
...
End Sub
'Initializes the VBadge component.
'Initializes the VBadge component.
...
'This builds the HTML tree based on defined properties for VBadge
'This builds the HTML tree based on defined properties for VBadge
...
End Sub
Sub SetColor(color As String, intensity As String)
sColor = VElement.BuildColor(color, intensity)
VC.SetData(xbadgecolor, sColor)
End Sub
...
End Sub
Sub SetHostColor(color As String, intensity As String)
mColor = VElement.BuildColor(color, intensity)
VC.SetData(xiconcolor, mColor)
End Sub
...
End Sub
'clear the value on the app
Sub ClearTextOnApp(A As VuetifyApp)
UpdateValueOnApp(A, 0)
End Sub
