...
'Definition of variables used in this VRangeSlider component.
'Definition of variables used in this VRangeSlider component.
Sub Class_Globals
...
End Sub
'Initializes the VRangeSlider component.
'Initializes the VRangeSlider component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VRangeSlider
'This builds the HTML tree based on defined properties for VRangeSlider
