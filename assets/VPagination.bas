...
'Definition of variables used in this VPagination component.
'Definition of variables used in this VPagination component.
Sub Class_Globals
...
End Sub
'Initializes the VPagination component.
'Initializes the VPagination component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VPagination
'This builds the HTML tree based on defined properties for VPagination
