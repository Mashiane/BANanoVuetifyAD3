...
'Definition of variables used in this VCheckBox component.
'Definition of variables used in this VCheckBox component.
Sub Class_Globals
...
End Sub
'Initializes the VCheckBox component.
'Initializes the VCheckBox component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VCheckBox
'This builds the HTML tree based on defined properties for VCheckBox
...
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VCheckBox
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
...
C.SetData(sVModel, vValue)
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VCheckBox
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
