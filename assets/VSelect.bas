...
'Definition of variables used in this VSelect component.
'Definition of variables used in this VSelect component.
Sub Class_Globals
...
End Sub
'Initializes the VSelect component.
'Initializes the VSelect component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VSelect
'This builds the HTML tree based on defined properties for VSelect
...
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VSelect
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
