...
'Definition of variables used in this VCarousel component.
'Definition of variables used in this VCarousel component.
Sub Class_Globals
...
End Sub
'Initializes the VCarousel component.
'Initializes the VCarousel component.
...
End Sub
'This builds the HTML tree based on defined properties for VCarousel
'This builds the HTML tree based on defined properties for VCarousel
...
C.SetData(mImagesSource, xItems)
End Sub
Sub AddItem(sID As String, sSrc As String, sHref As String, sTo As String, aDisabled As Boolean)
Dim nm As Map = CreateMap()
nm.Put("disabled", aDisabled)
nm.Put("href", sHref)
nm.Put("to", sTo)
nm.Put("value", sID)
nm.Put("src", sSrc)
