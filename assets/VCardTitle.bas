...
'Definition of variables used in this VCardTitle component.
'Definition of variables used in this VCardTitle component.
Sub Class_Globals
...
End Sub
'Initializes the VCardTitle component.
'Initializes the VCardTitle component.
...
End Sub
'This builds the HTML tree based on defined properties for VCardTitle
'This builds the HTML tree based on defined properties for VCardTitle
...
Else
mElement = mTarget.Append($"<v-card-title ref="${mName}" id="${mName}"></v-card-title>"$).Get("#" & mName)
End If
'
...
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VCardTitle
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VCardTitle
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
