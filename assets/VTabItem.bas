...
'Definition of variables used in this VTabItem component.
'Definition of variables used in this VTabItem component.
Sub Class_Globals
...
End Sub
'Initializes the VTabItem component.
'Initializes the VTabItem component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VTabItem
'This builds the HTML tree based on defined properties for VTabItem
