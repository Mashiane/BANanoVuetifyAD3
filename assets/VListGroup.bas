...
'Definition of variables used in this VListGroup component.
Sub Class_Globals
...
End Sub
'Initializes the VListGroup component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VListGroup
