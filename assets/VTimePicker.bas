...
'Definition of variables used in this VTimePicker component.
'Definition of variables used in this VTimePicker component.
Sub Class_Globals
...
End Sub
'Initializes the VTimePicker component.
'Initializes the VTimePicker component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VTimePicker
'This builds the HTML tree based on defined properties for VTimePicker
