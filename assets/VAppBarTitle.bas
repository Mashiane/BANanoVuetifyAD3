...
'Definition of variables used in this VAppBarTitle component.
'Definition of variables used in this VAppBarTitle component.
Sub Class_Globals
...
End Sub
'Initializes the VAppBarTitle component.
'Initializes the VAppBarTitle component.
...
'This builds the HTML tree based on defined properties for VAppBarTitle
'This builds the HTML tree based on defined properties for VAppBarTitle
...
VElement.SetData(xCaption, "")
xCaption = VElement.GetCaptionName(mText, $"${mName}caption"$)
VElement.SetCaptionValue(xCaption, mText, "App Title")
...
mText = sText
C.setdata(xCaption, sText)
End Sub
Sub UpdateTitleOnApp(C As VuetifyApp, sText As String)
mText = sText
C.setdata(xCaption, sText)
End Sub
Sub UpdateCaption(sText As String)
VC.setdata(xCaption, sText)
End Sub
Sub UpdateCaptionOnApp(C As VuetifyApp, sText As String)
mText = sText
C.setdata(xCaption, sText)
End Sub
...
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VAppBarTitle
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VAppBarTitle
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
