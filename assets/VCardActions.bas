...
'Definition of variables used in this VCardActions component.
'Definition of variables used in this VCardActions component.
Sub Class_Globals
...
End Sub
'Initializes the VCardActions component.
'Initializes the VCardActions component.
...
End Sub
'This builds the HTML tree based on defined properties for VCardActions
'This builds the HTML tree based on defined properties for VCardActions
...
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VCardActions
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VCardActions
C.SetData(mVIf, b)
C.SetData(mVShow, b)
Return Me
End Sub
