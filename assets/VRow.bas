...
#DesignerProperty: Key: Justify, DisplayName: Horizontal Align / Justify, FieldType: String, DefaultValue: normal, Description: Justify, List: normal|start|center|end|space-between|space-around
...
'Definition of variables used in this VRow component.
'Definition of variables used in this VRow component.
Sub Class_Globals
...
End Sub
'Initializes the VRow component.
'Initializes the VRow component.
...
'This builds the HTML tree based on defined properties for VRow
'This builds the HTML tree based on defined properties for VRow
