...
'Definition of variables used in this VListSlot component.
Sub Class_Globals
...
End Sub
'Initializes the VListSlot component.
...
End Sub
'This builds the HTML tree based on defined properties for VListSlot
...
Return Me
End Sub
'Sub UpdateVisible(C As VueComponent, b As Boolean) As VListSlot
'	C.SetData(sVIf, b)
'C.SetData(sVShow, b)
'	Return Me
'End Sub
