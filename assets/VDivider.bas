...
'Definition of variables used in this VDivider component.
'Definition of variables used in this VDivider component.
Sub Class_Globals
...
End Sub
'Initializes the VDivider component.
'Initializes the VDivider component.
...
End Sub
'This builds the HTML tree based on defined properties for VDivider
'This builds the HTML tree based on defined properties for VDivider
...
Else
mElement = mTarget.Append($"<v-divider ref="${mName}" id="${mName}"></v-divider>"$).Get("#" & mName)
End If
'
VElement.Initialize(mCallBack, mName, mName)
VElement.TagName = "v-divider"
...
BANano.SetMeToNull
End Sub
Sub AddClass(s As String) As VDivider
VElement.AddClass(s)
Return Me
End Sub
Sub AddAttr(p As String, v As Object) As VDivider
VElement.SetAttr(p, v)
Return Me
End Sub
Sub AddStyle(p As String, v As String) As VDivider
VElement.AddStyle(p, v)
Return Me
End Sub
Sub RemoveAttr(p As String) As VDivider
VElement.RemoveAttr(p)
Return Me
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VDivider
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VDivider
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
