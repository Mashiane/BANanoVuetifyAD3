...
'Definition of variables used in this VParallax component.
'Definition of variables used in this VParallax component.
Sub Class_Globals
...
End Sub
'Initializes the VParallax component.
'Initializes the VParallax component.
...
End Sub
'This builds the HTML tree based on defined properties for VParallax
'This builds the HTML tree based on defined properties for VParallax
...
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VParallax
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
