...
'Definition of variables used in this VToolBarTitle component.
'Definition of variables used in this VToolBarTitle component.
Sub Class_Globals
...
End Sub
'Initializes the VToolBarTitle component.
'Initializes the VToolBarTitle component.
...
'This builds the HTML tree based on defined properties for VToolBarTitle
'This builds the HTML tree based on defined properties for VToolBarTitle
...
Else
mElement = mTarget.Append($"<v-toolbar-title ref="${mName}" id="${mName}"></v-toolbar-title>"$).Get("#" & mName)
End If
VElement.Initialize(mCallBack, mName, mName)
VElement.TagName = "v-toolbar-title"
...
VC.SetData(xCaption, "")
End Sub
Sub ClearOnApp(C As VuetifyApp, s As String)
...
BANano.SetMeToNull
End Sub
Sub AddClass(s As String) As VToolBarTitle
VElement.AddClass(s)
Return Me
End Sub
Sub AddAttr(p As String, v As Object) As VToolBarTitle
VElement.SetAttr(p, v)
Return Me
End Sub
Sub AddStyle(p As String, v As String) As VToolBarTitle
VElement.AddStyle(p, v)
Return Me
End Sub
Sub RemoveAttr(p As String) As VToolBarTitle
