...
'
#DesignerProperty: Key: ItemKeys, DisplayName: Item Keys (Key)(;), FieldType: String, DefaultValue:  add; edit; delete; refresh, Description: Item Icons
#DesignerProperty: Key: ItemIcons, DisplayName: Item Icons (Value)(;), FieldType: String, DefaultValue:  mdi-plus; mdi-pencil; mdi-delete; mdi-refresh, Description: Item Icons
...
'Definition of variables used in this VLeaflet component.
Sub Class_Globals
...
Type VMarkerType(MarkerId As String, MarkerTitle As String, MarkerWindowOpened As Boolean, MarkerLatitude As String, MarkerLongitude As String, MarkerColor As String,  MarkerInforWindow As String, MarkerDraggable As Boolean, MarkerriseOnHover As Boolean, MarkerIconSize As List, MarkerIconAnchor As List, MarkerIcon As String, MarkerHasIcon As Boolean, MarkerHasIconColor As Boolean, MarkerIconColor As String, MarkerPopUp As String)
'
...
End Sub
'Initializes the VLeaflet component.
...
End Sub
'This builds the HTML tree based on defined properties for VLeaflet
...
ClearMarkersOnApp(A)
ClearCirclesOnApp(A)
ClearPolygonsOnApp(A)
ClearRectanglesOnApp(A)
End Sub
'clear the markers
...
'
VC.ImportBO("l-map", LMap)
VC.ImportBO("l-tile-layer", LTileLayer)
VC.ImportBO("l-marker", LMarker)
VC.ImportBO("l-tooltip", LTooltip)
VC.ImportBO("l-popup", LPopup)
VC.ImportBO("l-polyline", LPolyline)
VC.ImportBO("l-circle", LCircle)
VC.ImportBO("l-polygon", LPolygon)
VC.ImportBO("l-rectangle", LRectangle)
VC.ImportBO("l-geo-json", LGeoJson)
VC.ImportBO("l-icon", LIcon)
...
Dim LIcon As BANanoObject = Vue2Leaflet.GetField("LIcon")
'
c.ImportBO("l-map", LMap)
c.ImportBO("l-tile-layer", LTileLayer)
c.ImportBO("l-marker", LMarker)
c.ImportBO("l-tooltip", LTooltip)
c.ImportBO("l-popup", LPopup)
c.ImportBO("l-polyline", LPolyline)
c.ImportBO("l-circle", LCircle)
c.ImportBO("l-polygon", LPolygon)
c.ImportBO("l-rectangle", LRectangle)
c.ImportBO("l-geo-json", LGeoJson)
c.ImportBO("l-icon", LIcon)
Dim mbindings As Map = VElement.bindings
Dim mmethods As Map = VElement.methods
'apply the binding for the control
For Each k As String In mbindings.Keys
