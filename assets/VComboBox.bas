...
#DesignerProperty: Key: Delimiters, DisplayName: Delimiters, FieldType: String, DefaultValue: , Description: Delimiters
...
'Definition of variables used in this VComboBox component.
'Definition of variables used in this VComboBox component.
Sub Class_Globals
...
End Sub
'Initializes the VComboBox component.
'Initializes the VComboBox component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VComboBox
'This builds the HTML tree based on defined properties for VComboBox
...
sDelimiters = Props.Get("Delimiters")
...
VElement.AddAttr(":delimiters", sDelimiters)
VElement.SetData(sDelimiters, VElement.Newlist)
...
VElement.SetData(sNoDataText, Null)
...
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VComboBox
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VComboBox
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
