...
'Definition of variables used in this VSpacer component.
'Definition of variables used in this VSpacer component.
Sub Class_Globals
...
End Sub
'Initializes the VSpacer component.
'Initializes the VSpacer component.
...
'This builds the HTML tree based on defined properties for VSpacer
'This builds the HTML tree based on defined properties for VSpacer
...
Else
mElement = mTarget.Append($"<v-spacer id="${mName}"></v-spacer>"$).Get("#" & mName)
End If
VElement.Initialize(mCallBack, mName, mName)
VElement.TagName = "v-spacer"
...
BANano.SetMeToNull
End Sub
Sub AddClass(s As String) As VSpacer
VElement.AddClass(s)
Return Me
End Sub
Sub AddAttr(p As String, v As Object) As VSpacer
VElement.SetAttr(p, v)
Return Me
End Sub
Sub AddStyle(p As String, v As String) As VSpacer
VElement.AddStyle(p, v)
Return Me
End Sub
Sub RemoveAttr(p As String) As VSpacer
