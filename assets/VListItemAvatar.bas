...
'Definition of variables used in this VListItemAvatar component.
Sub Class_Globals
...
End Sub
'Initializes the VListItemAvatar component.
...
End Sub
'This builds the HTML tree based on defined properties for VListItemAvatar
...
Return Me
End Sub
'Sub UpdateVisible(C As VueComponent, b As Boolean) As VListItemAvatar
'	C.SetData(sVIf, b)
'C.SetData(sVShow, b)
'	Return Me
'End Sub
