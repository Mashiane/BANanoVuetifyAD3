...
'Definition of variables used in this VListItem component.
Sub Class_Globals
...
End Sub
'Initializes the VListItem component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VListItem
