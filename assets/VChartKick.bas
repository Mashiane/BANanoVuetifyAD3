...
'Definition of variables used in this VChartKick component.
Sub Class_Globals
...
End Sub
'Initializes the VChartKick component.
...
End Sub
'This builds the HTML tree based on defined properties for VChartKick
