...
'Definition of variables used in this VWebCam component.
Sub Class_Globals
...
End Sub
'Initializes the VWebCam component.
...
End Sub
'This builds the HTML tree based on defined properties for VWebCam
