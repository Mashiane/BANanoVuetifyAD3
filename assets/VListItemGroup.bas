...
'Definition of variables used in this VListItemGroup component.
Sub Class_Globals
...
End Sub
'Initializes the VListItemGroup component.
...
End Sub
'This builds the HTML tree based on defined properties for VListItemGroup
