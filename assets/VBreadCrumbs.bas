...
#DesignerProperty: Key: ItemKeys, DisplayName: Action Keys (Key)(;), FieldType: String, DefaultValue:  , Description: Action Icons
#DesignerProperty: Key: ItemTitles, DisplayName: Action Titles (Value)(;), FieldType: String, DefaultValue:  , Description: Action Titles
...
'Definition of variables used in this VBreadCrumbs component.
Sub Class_Globals
...
End Sub
'Initializes the VBreadCrumbs component.
...
End Sub
'This builds the HTML tree based on defined properties for VBreadCrumbs
...
xitems.Initialize
End Sub
Sub AddItem(sID As String, sText As String, sTo As String, sHref As String, bExact As Boolean, bLink As Boolean,  aDisabled As Boolean)
