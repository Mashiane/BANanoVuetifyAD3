...
'Definition of variables used in this VBottomSheet component.
'Definition of variables used in this VBottomSheet component.
'Definition of variables used in this VBottomSheet component.
Sub Class_Globals
...
End Sub
'Initializes the VBottomSheet component.
'Initializes the VBottomSheet component.
'Initializes the VBottomSheet component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VBottomSheet
'This builds the HTML tree based on defined properties for VBottomSheet
'This builds the HTML tree based on defined properties for VBottomSheet
...
VElement.AddAttr("v-model", sVShow)
