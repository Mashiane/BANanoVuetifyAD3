...
'Definition of variables used in this VChipGroup component.
'Definition of variables used in this VChipGroup component.
Sub Class_Globals
...
End Sub
'Initializes the VChipGroup component.
'Initializes the VChipGroup component.
...
End Sub
'This builds the HTML tree based on defined properties for VChipGroup
'This builds the HTML tree based on defined properties for VChipGroup
...
Return Me
End Sub
Sub UpdateVisible(C As VueComponent, b As Boolean) As VChipGroup
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
Sub UpdateVisibleOnApp(C As VuetifyApp, b As Boolean) As VChipGroup
C.SetData(sVIf, b)
C.SetData(sVShow, b)
Return Me
End Sub
...
End Sub
'update selected item
Sub SetSelected(C As VueComponent, xitems As List)
C.SetData(sVModel, xitems)
End Sub
'get selected item
Sub GetSelected(C As VueComponent) As List
...
End Sub
'update selected item
Sub SetSelectedOnApp(C As VuetifyApp, xitems As List)
C.SetData(sVModel, xitems)
End Sub
'get selected item
