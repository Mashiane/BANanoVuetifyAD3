...
'Definition of variables used in this VColorPicker component.
'Definition of variables used in this VColorPicker component.
Sub Class_Globals
...
End Sub
'Initializes the VColorPicker component.
'Initializes the VColorPicker component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VColorPicker
'This builds the HTML tree based on defined properties for VColorPicker
