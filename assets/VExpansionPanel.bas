...
'Definition of variables used in this VExpansionPanel component.
'Definition of variables used in this VExpansionPanel component.
Sub Class_Globals
...
End Sub
'Initializes the VExpansionPanel component.
'Initializes the VExpansionPanel component.
...
'sDisabled = $"${mName}disabled"$
End Sub
'This builds the HTML tree based on defined properties for VExpansionPanel
'This builds the HTML tree based on defined properties for VExpansionPanel
