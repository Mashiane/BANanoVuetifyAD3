...
Sub Init
	...
	vtoolbartitle.Caption = "WireFrame: Inbox"
	'
	LoadLayoutSpacer(Null)
...
'	LoadLayoutButtonIcon("navbar", "btnsquare", "mdi-square", Null, CreateMap("color":"red"))
'	vappbar.AppendHolder
'	'
'	LoadLayoutButtonIcon("navbar", "btncircle", "mdi-circle", Null, CreateMap("color":"yellow"))
'	vappbar.AppendHolder
'	'
'	LoadLayoutButtonIcon("navbar", "btntriangle", "mdi-triangle", Null, CreateMap("color":"blue"))
'	vappbar.AppendHolder
